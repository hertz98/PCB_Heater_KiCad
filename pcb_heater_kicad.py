...
def Help(out):
	print(os.path.basename(__file__) +' -x <size of X> -y <size of Y> -w <size of width> -t <thickness> -l <name of layer> -n <number of net> -s <space between wires> -r <resistivity>')
